/*
Função anonima é uma função qu não tem nome. Ela é atribuida a um elemento de evento ou a uma variavel.
Os Elementos de evento podem ser: butões, inputs, images e varios outros controles html.
*/

const body = document.body;

// Vamos criar um botão para adiconar a página;
...
// Criar um novo button bt2
const btn2 = document.createElement("button");
btn2.innerHTML = "Segunda função";

// adiconar o btn2 ao body
